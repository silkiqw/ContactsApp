...
public class DisplayContactByIdOptions {

    @NonNull
    private final String id;

    public DisplayContactByIdOptions(@NonNull PluginCall call) throws Exception {
    ...
    @NonNull
    private String getIdFromCall(@NonNull PluginCall call) throws Exception {
